...
const ColorBar2Active = () => {
  return (
    <Svg width={41} height={175} viewBox="0 0 41 175" fill="none">
    <Rect width="41" height="175" rx="6" fill="#EECEA8"/>
    ...
    <Rect x="0.5" y="0.5" width="40" height="174" rx="5.5" fill="#EECEA8" stroke="#5A534A"/>
...
export default ColorBar2Active;
