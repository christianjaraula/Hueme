  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.verticalRectanglesContainer}>
        <VerticalRectangle color="#71593E" />
        <VerticalRectangle color="#0F3940" />
        <VerticalRectangle color="#0E2359" />
        <VerticalRectangle color="#3D2545" />
        <VerticalRectangle color="#722631" />
        <VerticalRectangle color="#480923" />
      </View>

      <Text style={styles.text}>Deep Autumn scheme</Text>
