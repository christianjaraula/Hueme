  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.verticalRectanglesContainer}>
        <VerticalRectangle color="#49312A" />
        <VerticalRectangle color="#313524" />
        <VerticalRectangle color="#1F3343" />
        <VerticalRectangle color="#142153" />
        <VerticalRectangle color="#2C1D4E" />
        <VerticalRectangle color="#5A091E" />
      </View>

      <Text style={styles.text}>Deep Winter scheme</Text>
