  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.verticalRectanglesContainer}>
        <VerticalRectangle color="#ACA041" />
        <VerticalRectangle color="#2A6A2A" />
        <VerticalRectangle color="#07577D" />
        <VerticalRectangle color="#3A265F" />
        <VerticalRectangle color="#8B1245" />
        <VerticalRectangle color="#8F001F" />
      </View>
