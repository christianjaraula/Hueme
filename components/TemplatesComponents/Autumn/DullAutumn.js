  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.verticalRectanglesContainer}>
        <VerticalRectangle color="#766A4E" />
        <VerticalRectangle color="#67504D" />
        <VerticalRectangle color="#4B5D35" />
        <VerticalRectangle color="#3E5964" />
        <VerticalRectangle color="#4D566A" />
        <VerticalRectangle color="#595578" />
      </View>

      <Text style={styles.text}>Dull Autumn scheme</Text>
