  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.verticalRectanglesContainer}>
        <VerticalRectangle color="#414141" />
        <VerticalRectangle color="#319FC2" />
        <VerticalRectangle color="#0C3F83" />
        <VerticalRectangle color="#565FA2" />
        <VerticalRectangle color="#F9B2D0" />
        <VerticalRectangle color="#700C3A" />
      </View>

      <Text style={styles.text}>Cool Summer scheme</Text>
