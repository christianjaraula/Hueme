...
export default function CameraDisplay() {
    ...
    >
      <View style={styles.savedButtonContainer}>
        <TouchableOpacity onPress={handleColorSavedPress}>
          <Savedbutton width={moderateScale(30)} height={moderateScale(30)} color="white" />
        </TouchableOpacity>
      </View>
    </TouchableOpacity>
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>Warm Spring scheme</Text>
      ...
      <TouchableOpacity style={styles.arrowButton} onPress={() => navigation.goBack()}>
        <ArrowButtonLeft width={moderateScale(40)} height={moderateScale(40)} color="#5A534A" />
      </TouchableOpacity>
    </View>
  );
}
