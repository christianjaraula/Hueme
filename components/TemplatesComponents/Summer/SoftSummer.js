  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.verticalRectanglesContainer}>
        <VerticalRectangle color="#8D8076" />
        <VerticalRectangle color="#E7D89D" />
        <VerticalRectangle color="#5F957D" />
        <VerticalRectangle color="#FF9DBA" />
        <VerticalRectangle color="#F77C85" />
        <VerticalRectangle color="#5D5E7B" />
      </View>

      <Text style={styles.text}>Soft Summer scheme</Text>
