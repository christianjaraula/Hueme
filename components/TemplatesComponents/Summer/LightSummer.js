  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.verticalRectanglesContainer}>
        <VerticalRectangle color="#545C6B" />
        <VerticalRectangle color="#CDD0D7" />
        <VerticalRectangle color="#79DDB7" />
        <VerticalRectangle color="#268194" />
        <VerticalRectangle color="#92A9E4" />
        <VerticalRectangle color="#AD496F" />
      </View>

      <Text style={styles.text}>Light Summer scheme</Text>
